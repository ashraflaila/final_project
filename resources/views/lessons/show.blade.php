...
@section('sub-title', 'Lesson Details')
@section('styles')
<style>
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-md-3">
                            ...
                            <div class="detail-value">#{{ $lesson->id }}</div>
                        </div>
                        <div class="col-md-9">
                            <div class="detail-label">Title</div>
                            <div class="detail-value">{{ $lesson->title }}</div>
                        </div>
                    </div>
                    <div class="row mb-4">
                        <div class="col-md-4">
                            <div class="detail-label">Course</div>
                            <div class="detail-value">{{ $lesson->course->title ?? '-' }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="detail-label">Duration</div>
                            <div class="detail-value">{{ $lesson->duration !== null ? $lesson->duration . ' min' : '-' }}</div>
                        </div>
                        <div class="col-md-4">
                            <div class="detail-label">Video URL</div>
                            <div class="detail-value">{{ $lesson->video_url ?? 'No video provided.' }}</div>
                        </div>
                    </div>
                    <div class="mb-4">
                        <div class="detail-label">Content</div>
                        <div class="description-box">{{ $lesson->content ?? 'No content available.' }}</div>
                    </div>
                    <div class="d-flex" style="gap: 10px;">
                        <a href="{{ route('lessons.edit', $lesson->id) }}" class="btn-edit">Edit</a>
                        <a href="{{ route('lessons.index') }}" class="btn-back">Go Back</a>
                    </div>
                </div>
            </div>
        </div>
