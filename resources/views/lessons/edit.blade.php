        ...
        <div class="card-body">
            <form action="{{ route('lessons.update', $lesson->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="url" name="video_url" class="form-control" value="{{ $lesson->video_url }}" placeholder="https://example.com/video">
                </div>
                <div class="form-group">
                ...
                <a href="{{ route('lessons.index') }}" class="btn btn-back">Back</a>
            </form>
        </div>
    </div>
</div>
