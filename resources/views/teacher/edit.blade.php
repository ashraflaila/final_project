...
@section('sub-title', 'Edit Teacher Details')

@section('styles')
<style>
    .card-header-gradient {
        background: linear-gradient(135deg, #f7971e 0%, #ffd200 100%);
        color: #2c3e50; padding: 1rem 1.5rem; border-radius: 0.375rem 0.375rem 0 0;
    }
    ...
    .current-image { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #f7971e; display: block; margin-bottom: 8px; }
    .image-preview { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #11998e; display: none; margin-top: 10px; }
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header-gradient">
                    <h3><i class="fas fa-edit mr-2"></i> Edit Teacher</h3>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                    ...
                                    <select class="form-control @error('country_id') is-invalid @enderror" id="country_id" name="country_id">
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{ $country->id }}"
                                                {{ old('country_id', $teacher->country_id) == $country->id ? 'selected' : '' }}>
                                                {{ $country->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="name"><i class="fas fa-user mr-1 text-muted"></i> First Name</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $teacher->name) }}" placeholder="Enter First Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                        id="last_name" name="last_name" value="{{ old('last_name', $teacher->last_name) }}" placeholder="Enter Last Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                        id="mobile" name="mobile" value="{{ old('mobile', $teacher->mobile) }}" placeholder="Enter Mobile">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="date"><i class="fas fa-calendar mr-1 text-muted"></i> Date of Birth</label>
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        id="date" name="date" value="{{ old('date', $teacher->date ? $teacher->date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                        id="address" name="address" value="{{ old('address', $teacher->address) }}" placeholder="Enter Address">
                        ...
                        {{-- Bio --}}
                        <div class="section-title mt-2"><i class="fas fa-align-left mr-1"></i> Bio</div>
                        <div class="form-group">
                            <label for="bio"><i class="fas fa-pen mr-1 text-muted"></i> Teacher Bio</label>
                            <textarea class="form-control @error('bio') is-invalid @enderror"
                                id="bio" name="bio" placeholder="Write a brief biography about the teacher...">{{ old('bio', $teacher->bio) }}</textarea>
                        ...
                        <div class="form-group">
                            @if($teacher->image)
                                <img src="{{ asset('storage/' . $teacher->image) }}" class="current-image" alt="Current Image">
                            @endif
                        ...
                        <div class="d-flex" style="gap: 10px;">
                            <button type="button" class="btn-update" onclick="performUpdate({{ $teacher->id }})">
...
function performUpdate(id) {
    ...
    updateRoute('/cms/admin/teachers-update/' + id, data);
}
</script>
@endsection
