...
@section('sub-title', 'Create New Teacher')
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header-gradient">
                    <h3><i class="fas fa-chalkboard-teacher mr-2"></i> Add New Teacher</h3>
                </div>
                <div class="card-body p-4">
                    <form id="create_form" action="{{ route('teachers.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        {{-- Error Alert --}}
                        <div id="error_alert" class="alert alert-danger" hidden>
                            <ul id="error_messages_ul" class="mb-0 pl-3"></ul>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name') }}" placeholder="Enter First Name" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email') }}" placeholder="teacher@example.com" required>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                        id="mobile" name="mobile" value="{{ old('mobile') }}" placeholder="Enter Mobile">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('bio') is-invalid @enderror"
                                id="bio" name="bio" placeholder="Write a brief biography about the teacher...">{{ old('bio') }}</textarea>
...
function performStore() {
    ...
    storeRoute('/cms/admin/teachers', formData);
}
</script>
@endsection
