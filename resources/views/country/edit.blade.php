...
@section('sub-title', 'Edit Country Details')
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header-gradient">
                    <h3><i class="fas fa-edit mr-2"></i> Edit Country</h3>
                </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form id="create_form" action="{{ route('countries.update', $countries->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <hr class="mt-2">
                           ...
                           <div  class="d-flex" style="gap: 10px;">
                            ...
                            <button type="button" onclick="performUpdate({{ $countries->id }})" class="btn-update">
...
<script>
    function performUpdate(id) {
        ...
        updateRoute('/cms/admin/countries-update/' + id, data);
    }
</script>
@endsection
