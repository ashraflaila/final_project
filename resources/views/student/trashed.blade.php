...
@section('sub-title', 'Trashed Students')
...
<style>
    ...
    .email-badge { background: linear-gradient(135deg, #667eea, #764ba2); color: white; padding: 0.35rem 0.75rem; border-radius: 15px; font-size: 0.78rem; font-weight: 700; letter-spacing: 0.3px; display: inline-block; }
        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <div class="card-header-gradient d-flex justify-content-between align-items-center">
                    <h3><i class="fas fa-trash mr-2"></i> Trashed Students</h3>
                    <div style="display: flex; gap: 10px;">
                        <form action="{{ route('students.restore-all') }}" method="POST" class="d-inline"
                              onsubmit="return confirm('هل تريد استعادة كل الطلاب؟')">
                            @csrf
                        ...
                        <a href="{{ route('students.index') }}" class="btn-add">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span class="deleted-at-badge">
                                        ...
                                        {{ $student->deleted_at ? $student->deleted_at->format('Y-m-d H:i') : '-' }}
                                    </span>
                                </td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center" style="gap: 5px;">
                                        <form action="{{ route('students.restore.post', $student->id) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="btn btn-action" style="background:#d4edda; color:#1e7e34;" title="استعادة">
                                                <i class="fas fa-undo"></i>
                                            </button>
                                        </form>
                                        <a href="{{ route('students.show', $student->id) }}" class="btn btn-action" style="background:#d1ecf1; color:#0c7db1;" title="عرض">
                            ...
                            <tr>
                                <td colspan="4" class="text-center py-4">
                                    ...
                                    There are no students in trash.
                                </td>
                            </tr>
                            @endforelse
                        </tbody>
