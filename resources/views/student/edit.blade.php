...
@section('mine-title', 'Students Management')
@section('sub-title', 'Edit Student Details')
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header-gradient">
                    <h3><i class="fas fa-edit mr-2"></i> Edit Student</h3>
                </div>
                <div class="card-body p-4">
                    <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        id="name" name="name" value="{{ old('name', $student->name) }}" placeholder="Enter First Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('last_name') is-invalid @enderror"
                                        id="last_name" name="last_name" value="{{ old('last_name', $student->last_name) }}" placeholder="Enter Last Name">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('mobile') is-invalid @enderror"
                                        id="mobile" name="mobile" value="{{ old('mobile', $student->mobile) }}" placeholder="Enter Mobile">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('date') is-invalid @enderror"
                                        id="date" name="date" value="{{ old('date', $student->date ? $student->date->format('Y-m-d') : '') }}">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                        id="address" name="address" value="{{ old('address', $student->address) }}" placeholder="Enter Address">
                        ...
                        <div class="form-group">
                            @if($student->image)
                                <img src="{{ asset('storage/' . $student->image) }}" class="current-image" alt="Current Image">
                            @endif
                        ...
                        <div class="d-flex" style="gap: 10px;">
                            <button type="button" class="btn-update" onclick="performUpdate({{ $student->id }})">
...
function performUpdate(id) {
    ...
    updateRoute('/cms/admin/students-update/' + id, data);
}
</script>
@endsection
