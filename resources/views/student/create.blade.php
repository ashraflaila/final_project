...
@section('sub-title', 'Create New Student')
...
<style>
    ...
    .btn-save {
        ...
        box-shadow: 0 4px 15px rgba(102,126,234,0.35); cursor: pointer;
    }
    .btn-save:hover { color: white; transform: translateY(-2px); box-shadow: 0 6px 20px rgba(102,126,234,0.5); }
    .btn-back {
    ...
    .image-preview { width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 3px solid #667eea; display: none; margin-top: 10px; }
</style>
@endsection
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header-gradient">
                    <h3><i class="fas fa-user-graduate mr-2"></i> Add New Student</h3>
                </div>
                <div class="card-body p-4">
                    <form id="create_form" action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control @error('email') is-invalid @enderror"
                                        id="email" name="email" value="{{ old('email') }}" placeholder="student@example.com" required>
...
function performStore() {
    ...
    storeRoute('/cms/admin/students', formData);
}
</script>
@endsection
